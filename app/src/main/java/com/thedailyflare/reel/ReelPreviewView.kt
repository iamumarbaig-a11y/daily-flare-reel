...
class ReelPreviewView(context: Context) : View(context) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        // NONE is a genuine static text mode. Do not run the word-mask animation path.
        if (textEffect == "NONE") {
            ReelLayout.draw(canvas, title, headlines, width, height, null, false, ReelLayout.bodyWordCount(headlines))
            return
        }
